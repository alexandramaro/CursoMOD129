...
namespace CursoMOD129.Data.Migrations
{
    ...
    [Migration("20230515205752_Added_Missing_Email_Fields_on_Clients_and_TeamMembers")]
    partial class Added_Missing_Email_Fields_on_Clients_and_TeamMembers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CursoMOD129.Models.Appointment", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CursoMOD129.Models.Appointment", b =>
                {
                    b.HasOne("CursoMOD129.Models.Client", "Client")
                        .WithMany()
                        .HasForeignKey("ClientID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CursoMOD129.Models.TeamMember", "Medic")
                        .WithMany()
            ...
            modelBuilder.Entity("CursoMOD129.Models.TeamMember", b =>
                {
                    b.HasOne("CursoMOD129.Models.WorkRole", "WorkRole")
                        .WithMany()
